    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-72 right-28 opacity-7">
          <svg width="140" height="52" viewBox="0 0 140 52" fill="none" stroke="#D4AF37" strokeWidth="0.3">
        ...
        <div className="absolute bottom-40 left-16 opacity-9">
          <svg width="105" height="42" viewBox="0 0 105 42" fill="none" stroke="#9BB5FF" strokeWidth="0.4">
        ...
        <div className="absolute top-48 left-28 opacity-6">
          <svg width="180" height="22" viewBox="0 0 180 22" fill="none" stroke="#7DD3C0" strokeWidth="0.5">
            ...
            <circle cx="32" cy="8.5" r="0.8" fill="#7DD3C0" opacity="0.3" />
            <circle cx="88" cy="13.5" r="0.8" fill="#7DD3C0" opacity="0.3" />
            <circle cx="144" cy="9.5" r="0.8" fill="#7DD3C0" opacity="0.3" />
          </svg>
        </div>

        <div className="absolute bottom-56 right-20 opacity-7">
          <svg width="160" height="26" viewBox="0 0 160 26" fill="none" stroke="#D4AF37" strokeWidth="0.4">
            ...
            <circle cx="46" cy="11" r="0.7" fill="#D4AF37" opacity="0.4" />
            <circle cx="104" cy="15" r="0.7" fill="#D4AF37" opacity="0.4" />
          </svg>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl mb-8">
          <div
            ...
            style={{
              ...
              boxShadow: "inset 0 0 25px rgba(125, 211, 192, 0.12), 0 12px 40px rgba(125, 211, 192, 0.08)",
          ...
          >
            ...
            >
              <Shield className="w-6 h-6" style={{ color: "#0B0E14" }} strokeWidth={1.5} />
            </div>
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 20px rgba(212, 175, 55, 0.4), inset 0 0 10px rgba(255, 255, 255, 0.2)",
              }}
            >
              <TrendingUp className="w-6 h-6" style={{ color: "#0B0E14" }} strokeWidth={1.5} />
            </div>
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 20px rgba(155, 181, 255, 0.4), inset 0 0 10px rgba(255, 255, 255, 0.2)",
              }}
            >
              <BookOpen className="w-6 h-6" style={{ color: "#0B0E14" }} strokeWidth={1.5} />
            </div>
          ...
          <div
            ...
            style={{
              backgroundColor: "rgba(28, 31, 46, 0.3)",
              boxShadow:
                "inset 0 0 25px rgba(125, 211, 192, 0.08), inset 0 0 25px rgba(212, 175, 55, 0.08), inset 0 0 25px rgba(155, 181, 255, 0.08), 0 12px 40px rgba(125, 211, 192, 0.06)",
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow: "0 0 20px rgba(125, 211, 192, 0.3), inset 0 0 10px rgba(255, 255, 255, 0.2)",
              }}
            >
              <Users className="w-6 h-6" style={{ color: "#0B0E14" }} strokeWidth={1.5} />
            </div>
