    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-16 opacity-10">
          <svg width="150" height="75" viewBox="0 0 150 75" fill="none" stroke="#7DD3C0" strokeWidth="0.4">
        ...
        <div className="absolute top-60 right-24 opacity-8">
          <svg width="120" height="50" viewBox="0 0 120 50" fill="none" stroke="#D4AF37" strokeWidth="0.3">
        ...
        <div className="absolute bottom-40 left-20 opacity-9">
          <svg width="100" height="40" viewBox="0 0 100 40" fill="none" stroke="#9BB5FF" strokeWidth="0.4">
        ...
        <div className="absolute top-80 left-12 opacity-7">
          <svg width="200" height="20" viewBox="0 0 200 20" fill="none" stroke="#7DD3C0" strokeWidth="0.5">
            ...
            <circle cx="30" cy="7" r="0.8" fill="#7DD3C0" opacity="0.3" />
            <circle cx="90" cy="13" r="0.8" fill="#7DD3C0" opacity="0.3" />
            <circle cx="150" cy="8" r="0.8" fill="#7DD3C0" opacity="0.3" />
          </svg>
        </div>

        <div className="absolute bottom-60 right-20 opacity-6">
          <svg width="180" height="25" viewBox="0 0 180 25" fill="none" stroke="#D4AF37" strokeWidth="0.4">
            ...
            <circle cx="50" cy="10" r="0.6" fill="#D4AF37" opacity="0.4" />
            <circle cx="110" cy="15" r="0.6" fill="#D4AF37" opacity="0.4" />
          </svg>
        </div>
        ...
        <Heart
          ...
          style={{ color: "#7DD3C0", animationDelay: "3.5s", animationDuration: "4.2s" }}
        />
        <Heart
          className="absolute top-1/8 left-2/3 w-4 h-4 animate-bounce opacity-17"
          style={{ color: "#D4AF37", animationDelay: "0.7s", animationDuration: "3.9s" }}
        />
        <Heart
          className="absolute bottom-1/8 left-1/3 w-3 h-3 animate-bounce opacity-13"
          style={{ color: "#9BB5FF", animationDelay: "4.5s", animationDuration: "4.1s" }}
        />
        ...
        <Star
          ...
          style={{ color: "#D4AF37", animationDelay: "4s", animationDuration: "3.5s" }}
        />
        <Star
          className="absolute top-1/6 left-1/4 w-3 h-3 animate-pulse opacity-19"
          style={{ color: "#9BB5FF", animationDelay: "1.1s", animationDuration: "2.9s" }}
        />
        <Star
          className="absolute bottom-2/3 right-1/8 w-4 h-4 animate-pulse opacity-15"
          style={{ color: "#7DD3C0", animationDelay: "3.3s", animationDuration: "3.4s" }}
        />
        <Star
          className="absolute top-5/6 right-2/3 w-3 h-3 animate-pulse opacity-17"
          style={{ color: "#D4AF37", animationDelay: "0.4s", animationDuration: "2.6s" }}
        />
      </div>
