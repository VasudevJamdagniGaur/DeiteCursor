    ...
    >
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-16 opacity-8">
          <svg width="120" height="60" viewBox="0 0 120 60" fill="none" stroke="#7DD3C0" strokeWidth="0.4">
        ...
        <div className="absolute top-40 right-20 opacity-7">
          <svg width="100" height="45" viewBox="0 0 100 45" fill="none" stroke="#D4AF37" strokeWidth="0.3">
        ...
        <div className="absolute bottom-32 left-12 opacity-9">
          <svg width="140" height="55" viewBox="0 0 140 55" fill="none" stroke="#9BB5FF" strokeWidth="0.4">
        ...
        <div className="absolute top-60 left-8 opacity-6">
          <svg width="200" height="25" viewBox="0 0 200 25" fill="none" stroke="#7DD3C0" strokeWidth="0.5">
            ...
            <circle cx="30" cy="6" r="1" fill="#7DD3C0" opacity="0.2" />
            <circle cx="90" cy="18" r="1" fill="#7DD3C0" opacity="0.2" />
            <circle cx="150" cy="10" r="1" fill="#7DD3C0" opacity="0.2" />
          </svg>
        </div>

        <div className="absolute bottom-48 right-16 opacity-7">
          <svg width="180" height="30" viewBox="0 0 180 30" fill="none" stroke="#D4AF37" strokeWidth="0.4">
      ...
      <div className="relative z-10 fade-in">
        <div
          ...
          style={{
            ...
            boxShadow: "inset 0 0 30px rgba(125, 211, 192, 0.15), 0 16px 48px rgba(125, 211, 192, 0.1)",
            border: "1px solid rgba(125, 211, 192, 0.2)",
          }}
        >
          <Brain className="w-12 h-12 relative z-10" style={{ color: "#7DD3C0" }} strokeWidth={1.5} />
        </div>
        
        {/* Loading indicator */}
        <div className="mt-8 flex justify-center">
          <div className="w-8 h-1 rounded-full" style={{ backgroundColor: "rgba(125, 211, 192, 0.3)" }}>
            <div 
