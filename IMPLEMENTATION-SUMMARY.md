...
- **RunPod Integration**: Uses your RunPod Ollama instance at `https://f86jl4i8p64dqs-11434.proxy.runpod.net/`
...
await fetch('https://f86jl4i8p64dqs-11434.proxy.runpod.net/api/generate', {
  method: 'POST',
  body: JSON.stringify({
    model: 'llama3:70b',
    prompt: 'Hello',
...
setInterval(() => {
  fetch('https://f86jl4i8p64dqs-11434.proxy.runpod.net/api/generate', {
    method: 'POST',
    body: JSON.stringify({
      model: 'llama3:70b',
      prompt: 'ping',
...
```javascript
const OLLAMA_BASE_URL = 'https://f86jl4i8p64dqs-11434.proxy.runpod.net/';
