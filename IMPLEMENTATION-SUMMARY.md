...
- **RunPod Integration**: Uses your RunPod Ollama instance at `https://g75uux69gnczn1-11434.proxy.runpod.net/`
...
await fetch('https://g75uux69gnczn1-11434.proxy.runpod.net/api/generate', {
  method: 'POST',
  body: JSON.stringify({
    model: 'llama3:70b',
    prompt: 'Hello',
...
setInterval(() => {
  fetch('https://g75uux69gnczn1-11434.proxy.runpod.net/api/generate', {
    method: 'POST',
    body: JSON.stringify({
      model: 'llama3:70b',
      prompt: 'ping',
...
```javascript
const OLLAMA_BASE_URL = 'https://g75uux69gnczn1-11434.proxy.runpod.net/';
