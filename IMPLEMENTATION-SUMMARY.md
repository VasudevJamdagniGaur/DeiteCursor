...
- **RunPod Integration**: Uses your RunPod Ollama instance at `https://lbufw9sjdel4lo-11434.proxy.runpod.net/`
...
await fetch('https://lbufw9sjdel4lo-11434.proxy.runpod.net/api/generate', {
  method: 'POST',
  body: JSON.stringify({
    model: 'llama3:70b',
    prompt: 'Hello',
...
setInterval(() => {
  fetch('https://lbufw9sjdel4lo-11434.proxy.runpod.net/api/generate', {
    method: 'POST',
    body: JSON.stringify({
      model: 'llama3:70b',
      prompt: 'ping',
...
```javascript
const OLLAMA_BASE_URL = 'https://lbufw9sjdel4lo-11434.proxy.runpod.net/';
