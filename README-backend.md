...
- Ollama running on RunPod (https://5omad6zq0ez4f5-11434.proxy.runpod.net/)
...
2. **Verify Ollama is running on RunPod**:
   ```bash
   curl https://5omad6zq0ez4f5-11434.proxy.runpod.net/api/tags
   ```
...
```javascript
const OLLAMA_BASE_URL = 'https://5omad6zq0ez4f5-11434.proxy.runpod.net';  // RunPod Ollama API URL
...
- Ensure Ollama is running on RunPod: `curl https://5omad6zq0ez4f5-11434.proxy.runpod.net/api/tags`
- Check if model exists: `curl https://5omad6zq0ez4f5-11434.proxy.runpod.net/api/tags`
- Verify RunPod Ollama API is accessible: `curl https://5omad6zq0ez4f5-11434.proxy.runpod.net/api/tags`
