...
- Ollama running on RunPod (https://uklqo1rhs5bebp-11434.proxy.runpod.net/)
...
2. **Verify Ollama is running on RunPod**:
   ```bash
   curl https://uklqo1rhs5bebp-11434.proxy.runpod.net/api/tags
   ```
...
```javascript
const OLLAMA_BASE_URL = 'https://uklqo1rhs5bebp-11434.proxy.runpod.net/';  // RunPod Ollama API URL
...
- Ensure Ollama is running on RunPod: `curl https://uklqo1rhs5bebp-11434.proxy.runpod.net/api/tags`
- Check if model exists: `curl https://uklqo1rhs5bebp-11434.proxy.runpod.net/api/tags`
- Verify RunPod Ollama API is accessible: `curl https://uklqo1rhs5bebp-11434.proxy.runpod.net/api/tags`
