...
- Ollama running on RunPod (https://f86jl4i8p64dqs-11434.proxy.runpod.net/)
...
2. **Verify Ollama is running on RunPod**:
   ```bash
   curl https://f86jl4i8p64dqs-11434.proxy.runpod.net/api/tags
   ```
...
```javascript
const OLLAMA_BASE_URL = 'https://f86jl4i8p64dqs-11434.proxy.runpod.net/';  // RunPod Ollama API URL
...
- Ensure Ollama is running on RunPod: `curl https://f86jl4i8p64dqs-11434.proxy.runpod.net/api/tags`
- Check if model exists: `curl https://f86jl4i8p64dqs-11434.proxy.runpod.net/api/tags`
- Verify RunPod Ollama API is accessible: `curl https://f86jl4i8p64dqs-11434.proxy.runpod.net/api/tags`
