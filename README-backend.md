...
- Ollama running on RunPod (https://itdbhqcpemx28d-11434.proxy.runpod.net/)
...
2. **Verify Ollama is running on RunPod**:
   ```bash
   curl https://itdbhqcpemx28d-11434.proxy.runpod.net/api/tags
   ```
...
```javascript
const OLLAMA_BASE_URL = 'https://itdbhqcpemx28d-11434.proxy.runpod.net/';  // RunPod Ollama API URL
...
- Ensure Ollama is running on RunPod: `curl https://itdbhqcpemx28d-11434.proxy.runpod.net/api/tags`
- Check if model exists: `curl https://itdbhqcpemx28d-11434.proxy.runpod.net/api/tags`
- Verify RunPod Ollama API is accessible: `curl https://itdbhqcpemx28d-11434.proxy.runpod.net/api/tags`
